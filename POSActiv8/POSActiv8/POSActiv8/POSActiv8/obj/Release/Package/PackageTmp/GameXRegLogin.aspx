<%@ Page Title="Login" Language="C#" MasterPageFile="~/LoginMaster.Master" AutoEventWireup="true" CodeBehind="GameXRegLogin.aspx.cs" Inherits="POSActiv8.GameXRegLogin" %>
        ...
        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div id="divLogin" runat="server" class="card shadow" style="width:25rem;">
                ...
                <div class="card-body">
                    ...
                    <div class="pt-4 pb-2">
                        <h5 class="card-title text-center pb-0 fs-4">Login - GameX Registration</h5>
