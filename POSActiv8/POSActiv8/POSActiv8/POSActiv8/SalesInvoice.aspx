...
<div id="divButtonControls" runat="server" class="section">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <asp:TextBox ID="txtTransactionDateFrom" runat="server" CssClass="form-control" type="date"></asp:TextBox>
        </div>

        <div class="col-md-4 mb-3">
            <asp:TextBox ID="txtTransactionDateTo" runat="server" CssClass="form-control" type="date"></asp:TextBox>
        </div>
