<%@ Page Title="Tax" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Tax.aspx.cs" Inherits="POSActiv8.Tax" %>
...
<div id="divButtonControls" runat="server" class="section">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
             <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" placeholder="Search for tax name" ToolTip="Type in to find specific equipment"></asp:TextBox>
        </div>
       ...
       <div class="col-md-8 mb-3" style="text-align:right;">
            ...
            <asp:Button ID="btnCreate" runat="server" CssClass="btn btn-primary" Text="Create New" OnClick="btnCreate_Click" ToolTip="Click to create new tax" />
       </div>
...
<div id="divTax" runat="server" class="section">

    <p>
        <label id="lblTax" runat="server"></label>
    </p>

    <div class="table-responsive">
   
        <asp:GridView ID="gvTax" runat="server" CssClass="table table-bordered table-hover align-middle" AutoGenerateColumns="false" ShowHeader="true" ShowFooter="false" GridLines="None" onrowcommand="gvTax_RowCommand">
        <Columns>
    ...
    <!--Tax Details-->
    <div id="modalTaxDetails" class="modal fade" role="dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">
                    <asp:Label ID="lblTaxDetailsTitle" runat="server"></asp:Label>
                </h5>
            ...
            <div class="modal-body">
                Tax Name
                <br />
                <input type="text" id="txtTaxName" runat="server" class="form-control" tabindex="1"/>
                <br />

                Tax Amount
                <br />
                <input type="number" id="txtTaxAmount" runat="server" class="form-control text-end" tabindex="2" />
                <br />
    ...
    <script type="text/javascript">
        function showModal() {
            var myModal = new bootstrap.Modal(document.getElementById('modalTaxDetails'), { keyboard: false });
            myModal.show();
        }
    </script>
